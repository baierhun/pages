...
### **Grades**
Grades are calculated using a **points-based system**. Each assignment, quiz, project, and test, along with your class conduct, is worth a set number of points, and your grade is based on the total number of points you earn compared with the total points possible. Larger assignments are worth more points and therefore have a greater impact on your overall grade. Your final exam or project gets averaged in after your course grade is calculated.
...
You may **not** receive, request, or use any information about a test **before** taking it. You may not share any information about a test **after** taking it.

Technology may only be used during a test when specifically stated. Only those technologies that are specified can be used. To be safe, assume you cannot use a technology and ask if you are unsure. 

Any violation of these rules may result in loss of credit, a failing grade on the test, and/or further academic consequences according to school policy.
...
You begin the term with full conduct credit. Points are deducted only when expectations are not met. Deductions may occur for 
* attendance issues such as unexcused absences, tardiness, or frequently missing class
* lack of cooperation with classmates, including unwillingness to contribute productively to group activities
* inappropriate use of technology, such as using devices for non-class purposes
* general classroom conduct that disrupts learning or does not meet established behavioral expectations.
