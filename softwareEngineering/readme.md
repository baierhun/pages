...
[paulbaier@hunschool.org](mailto:paulbaier@hunschool.org)

[Google Meet](https://meet.google.com/nyk-mbjn-xwz)

Office: Chesebro 128a 

(609) 921-7600, ext. 3412 

---
How can we design and build software that is reliable, efficient, and solves real-world problems? Software Engineering with Java Honors is a year long course that explores a range of topics within the field of software engineering. We will develop proficiency with industry-standard tools, expand our understanding of programming through new paradigms and concepts, and deepen our expertise in familiar languages like Java.
...
## **Materials & Supplies** 
---
* Laptop capable of running the Java Software Development Kit (SDK)
...
**Participation: 15% of grade (deductive)**


## **Expectations**
---
* Arrive on time and be prepared with a **charged device** and all needed supplies.  
* You will use your iPad/device in accordance with the policy outlined in the school handbook. Abuse of this privilege will result in points deducted from the student’s grade as you will not be able to participate in assigned class work without the device.  
* Students are expected to follow ALL school rules including dress code while in class.  
...
Plagiarism, copying answers, logging in as someone else to complete assignments, and **any** other method where a student has not completed his/her own work honestly and independently \- will result in a **zero** and a referral to the Dean of Students.

Plagiarism in coding means presenting someone else’s work as your own. This includes copying all or part of a program from a classmate, online source, AI tool, or prior student. You must not look at, type for, or use each other’s computers to work on any work being handed in. All work should be entirely your own, and you must be able to explain every line of your code in detail. Using AI-generated code, copying explanations or analysis, or submitting old work (yours or others) from previous assignments or courses is also considered plagiarism. Violating these rules may result in academic disciplinary action.

### **Participation** 

You begin the term with full participation credit, and points are deducted only when expectations are not met. Deductions may occur for attendance issues such as unexcused absences, tardiness, or frequently missing class; lack of cooperation with classmates, including unwillingness to contribute productively to group activities; inappropriate use of technology, such as using devices for non-class purposes; and general classroom conduct that disrupts learning or does not meet established behavioral expectations. The goal of this system is to reward consistent positive engagement by maintaining full credit, while clearly identifying areas where points may be lost.

### **Technical Issues** 

Technical issues are not an automatic excuse for late work. If the platform we use is not working for you, you must email me as soon as possible to let me know what is happening. However, the assignment should still be considered due on the original deadline, and you are responsible for continuing to work on the problem and seeking a solution. Only if the platform officially announces system-wide downtime will assignment deadlines be extended.
...
Requests for extensions or accommodations must be made with me at least one week in advance of any assignments or assessments.
